...
alongside the features, in [make/make.md](make/make.md).
...
| [spliceopaque](spliceopaque/spliceopaque.md) | Splice opaque aliases over Seq and Array in vararg positions | 3.8, 3.9, 3.10 | feature | yes (2: `repro`, `repro-cc`) |
