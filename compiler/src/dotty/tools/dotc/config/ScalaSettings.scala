...
private sealed trait XSettings:
  ...
  val Xjsr45: Setting[Boolean] = BooleanSetting(AdvancedSetting, "Xjsr45", "Emit JSR-45 SourceDebugExtension (SMAP) attributes mapping inlined code back to its original source files.")
